...
export default function AboutPage() {
  ...
  const skills = ['JavaScript', 'Python', 'Swift', 'Kotlin', 'React', 'Node.js', 'HTML/CSS', 'Git', 'Bash', 'Docker']
          ...
          <SimpleGrid columns={{ base: 1, lg: 2 }} spacing={12} alignItems="start">
            <VStack align="start" spacing={8}>
              ...
              >
                ...
                <VStack align="start" spacing={4} fontFamily="mono" fontSize="sm" lineHeight="1.8">
                  <Text>
              ...
              >
                ...
                <VStack align="start" spacing={2} fontFamily="mono" fontSize="sm">
